...
//				tpeFlag=Tools.parseBoolean(b);
	...
	public void process(){
		...
		filter(out1s, out2s, out1s, out2s, qfout1s, qfout2s, qfout1s, qfout2s, trimPrefix, filterPrefix, true);
		delete(trimPrefix,  out1s, out2s, qfout1s, qfout2s);
		if(normalize || ecc){
			dehumanize(out1s, out2s, out1s, out2s, qfout1s, qfout2s, filterPrefix, humanPrefix, true, true);
			delete(filterPrefix,  out1s, out2s, qfout1s, qfout2s);
			Data.unloadAll();
			ReadWrite.ZIPLEVEL=oldZL;
			ReadWrite.ALLOW_ZIPLEVEL_CHANGE=true;
			normalize(out1s, out2s, out1, out2, qfout1s, qfout2s, qfout1, qfout2, humanPrefix, true);
			delete(humanPrefix, out1s, out2s, qfout1s, qfout2s);
		}else{
			ReadWrite.ZIPLEVEL=oldZL;
			ReadWrite.ALLOW_ZIPLEVEL_CHANGE=true;
			dehumanize(out1s, out2s, out1, out2, qfout1s, qfout2s, filterPrefix, "", true, false);
			delete(filterPrefix, out1s, out2s, qfout1s, qfout2s);
			Data.unloadAll();
		}
