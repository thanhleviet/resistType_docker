...
public abstract class ConcurrentReadInputStream implements ConcurrentReadStreamInterface {
	...
	protected static ConcurrentReadInputStream getReadInputStream(long maxReads, boolean colorspace, boolean keepSamHeader, boolean allowSubprocess, String...args){
...
//		}
	...
	public static ConcurrentReadInputStream getReadInputStream(long maxReads, boolean colorspace, boolean keepSamHeader, FileFormat ff1, FileFormat ff2){
		return getReadInputStream(maxReads, colorspace, keepSamHeader, ff1, ff2, (String)null, (String)null, Shared.USE_MPI, Shared.MPI_KEEP_ALL);
	}
	
	public static ConcurrentReadInputStream getReadInputStream(long maxReads, boolean colorspace, boolean keepSamHeader, FileFormat ff1, FileFormat ff2, 
			final boolean mpi, final boolean keepAll){
		return getReadInputStream(maxReads, colorspace, keepSamHeader, ff1, ff2, (String)null, (String)null, mpi, keepAll);
	}
	
	public static ConcurrentReadInputStream getReadInputStream(long maxReads, boolean colorspace, boolean keepSamHeader, 
			FileFormat ff1, FileFormat ff2, String qf1, String qf2){
		return getReadInputStream(maxReads, colorspace, keepSamHeader, ff1, ff2, qf1, qf2, Shared.USE_MPI, Shared.MPI_KEEP_ALL);
	}
	...
	public static ConcurrentReadInputStream getReadInputStream(long maxReads, boolean colorspace, boolean keepSamHeader, 
		...
		if(mpi){
			...
			if(rank==0){
				cris0=getReadInputStream(maxReads, colorspace, keepSamHeader, ff1, ff2, qf1, qf2, false, true);
				cris0.start();
			}else{
				cris0=null;
			}
