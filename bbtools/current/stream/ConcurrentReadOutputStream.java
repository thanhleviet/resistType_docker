...
public final class ConcurrentReadOutputStream {
	...
	public static ConcurrentReadOutputStream getStream(FileFormat ff1, FileFormat ff2, String qf1, String qf2,
		...
		return new ConcurrentReadOutputStream(ff1, ff2, qf1, qf2, maxSize, header, useSharedHeader);
	}
	...
	private ConcurrentReadOutputStream(FileFormat ff1_, FileFormat ff2_, String qf1, String qf2, int maxSize, CharSequence header, boolean useSharedHeader){
		ff1=ff1_;
		ff2=ff2_;
